...
export const routes: Routes = [
    ...
    { path: 'ficha-tecnicaFo/programado/:id', title: "Ficha Técnica FO", component: FichaTecnicaFOComponent },
    { path: 'ficha-tecnicaFo/programado/:id', title: "Ficha Técnica FO", component: FichaTecnicaFOComponent },
    { path: 'centros-de-proceso', title: "Centros de Proceso", component: CentrosDeProcesoComponent },
    { path: 'centros-de-proceso/:centrodeproceso/dashboard', title: "Centros de Proceso", component: DashboardEmbarcacionesComponent },
    // Tablas
    ...
    { path: 'centros-de-proceso/:centrodeproceso/dashboard/:embarcacion/programado', title: "Programadas", component: ProgramadasTotalComponent },
    { path: 'centros-de-proceso/:centrodeproceso/dashboard/:embarcacion/realizado', title: "Realizadas", component: RealizadasTotalComponent },
    { path: 'centros-de-proceso/:centrodeproceso/dashboard/:embarcacion/rezago', title: "Rezagadas", component: RezagadasTotalComponent },
    { path: 'centros-de-proceso/:centrodeproceso/dashboard/:embarcacion/fuera-de-programa', title: "Fuera de Programa", component: FueraDeProgramaTotalComponent },
    ...
    { path: 'centros-de-proceso/:centrodeproceso/dashboard/:embarcacion/programado/:id', title: "Programadas", component: ActividadesProgramadasComponent },
    { path: 'centros-de-proceso/:centrodeproceso/dashboard/:embarcacion/realizado/:id', title: "Realizadas", component: ActividadesRealizadasComponent },
    { path: 'centros-de-proceso/:centrodeproceso/dashboard/:embarcacion/rezago/:id', title: "Rezagadas Realizadas", component: ActividadesRealizadasRezagadasComponent },
    { path: 'centros-de-proceso/:centrodeproceso/dashboard/:embarcacion/fuera-de-programa/:id', title: "Fuera de Programa Realizadas", component: ActividadesRealizadasFueraDeProgramaComponent },
